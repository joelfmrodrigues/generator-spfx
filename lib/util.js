...
class Util {
    ...
    fastServe(yeoman) {
        ...
        if (yeoman.options.vetting.indexOf('spfx-fast-serve') !== -1) {
            ...
            yeoman.log(chalk.yellow('*** IMPORTANT: spfx-fast-serve may display a configuration error regarding webpack task mergeConfig. This should be handled by the generator and you can ignore the error.'));
        }
